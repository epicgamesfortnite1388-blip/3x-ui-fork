...
func runSeeders(isUsersEmpty bool) error {
	...
	if err := seedDefaultProvider(); err != nil {
		return err
	}
	return nil
}
...
func seedDefaultProvider() error {
	var count int64
	if err := db.Model(&model.ProviderRecord{}).Count(&count).Error; err != nil {
		return err
	}
	if count > 0 {
		return nil
	}
	return db.Create(&model.ProviderRecord{
		Name:      "xray",
		Type:      "native",
		Config:    "{}",
		IsEnabled: true,
