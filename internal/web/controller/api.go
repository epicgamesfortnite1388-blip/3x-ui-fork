...
func (a *APIController) initRouter(g *gin.RouterGroup) {
	...
	a.providerController = NewProviderController(providers, a.ProviderRegistry)

	subscriptions := api.Group("/subscriptions")
	a.subscriptionController = NewSubscriptionController(subscriptions, a.ProviderRegistry)
